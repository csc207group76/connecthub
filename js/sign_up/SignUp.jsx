  ...
  return (
    <form className="authentification-form">
      ...
      <div id="username-input" className="input-group">
        ...
        <input name="username" type="text" id="username-input" placeholder="ProfessorHankySpanky" ref={usernameRef} />
      </div>

      <div id="full-name-input" className="input-group">
        <label>Full Name: </label>
        <input name="fullName" type="text" id="full-name-input" placeholder="Doodle Wacker" ref={fullNameRef} />
      </div>
